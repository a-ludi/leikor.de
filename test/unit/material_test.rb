...
class MaterialTest < ActiveSupport::TestCase
  ...
  test "should use 'id-name.url_safe' as param" do
    @param = "606437365-teakholz"
    assert_equal @param, @material.to_param
    assert_equal @material, Material.from_param(@param)
